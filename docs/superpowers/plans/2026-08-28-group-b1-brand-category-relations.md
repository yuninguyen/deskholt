...
- [x] **Step 4:** Push the branch, open a PR against `main` (same flow as PR #3/#4/#5/#6: isolated worktree, own branch, CI green, `mergeable_state: clean`). Do not merge locally.
