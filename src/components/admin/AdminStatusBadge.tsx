...
const badgeVariants = {
  ...
  brand: 'border-[rgba(34,197,94,0.18)] bg-[rgba(34,197,94,0.08)] text-[#15803D] dark:border-[rgba(74,222,128,0.18)] dark:bg-[rgba(74,222,128,0.10)] dark:text-[#86EFAC]',
...
const dotVariants = {
  ...
  brand: 'bg-[#22C55E] dark:bg-[#4ADE80]',
